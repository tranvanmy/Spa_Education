...
export default {
    name: 'AdminResearchDevelopmentEdit',

    components: { cSwitch, UploadImage, Editor },

    async beforeCreate() {
        Helper.changeTitleAdminPage(this.$i18n.t('textManageResearchDevelopment'))
        await this.$store.dispatch('actionFetchCategory', { vue: this })
        await this.$store.dispatch('actionResearchDevelopmentShow', { vue: this, id: this.$route.params.id })
    },
    ...
    computed: {
        formData() {
            let data = this.$store.state.storeAdminResearchDevelopment.edit.data
    ...
    methods: {
        ...
        getCurrentImages() {
            return [this.$store.state.storeAdminResearchDevelopment.edit.data.image_url]
        },
        ...
        clickSubmitEdit() {
            ...
            this.$store.dispatch('actionResearchDevelopmentEdit', { vue: this, params, id: this.$route.params.id });
        },
