...
<script>
    ...
    export default {
        ...
        beforeCreate() {
            ...
            this.$store.dispatch('actionFetchCourses', { vue: this })
        },
        ...
        data() {
            return {
                fields: [
                    ...
                    {key: 'level', label: this.$i18n.t('textLevel'), tdClass: 'text-left'},
        ...
        methods: {
            clickAddNewItem() {
                return this.$router.push({ path: '/courses/add' })
            },

            clickEditItem(data) {
                return this.$router.push({ path: `/courses/edit/${data.id}` })
            },
            ...
            async clickDeleteItem(id) {
                return id
                    ...
                    && this.$store.dispatch('actionCourseDelete', { vue: this, id })
            },

            changePage(page) {
                this.$store.dispatch('actionCourseSetPage', { page })
            },

            handleChangeValueFilter(value) {
                return this.$store.dispatch('actionCourseSetFilter', { value: value.trim() })
            },
        },
        ...
        computed: {
            currentPage: {
                get() {
                    return this.$store.state.storeAdminCourse.currentPage
                },
                set(value) {}
            },

            valueFilter() {
                return this.$store.state.storeAdminCourse.valueFilter
            },
            ...
            items() {
                return this.$store.state.storeAdminCourse.listFetch
            },
        },
    }
</script>
