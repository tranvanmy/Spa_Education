...
export default {
    ...
    beforeCreate() {
        ...
        this.$store.dispatch('actionAboutUsShow', { vue: this, id: this.$route.params.id })
    },

    computed: {
        formData() {
            let data = this.$store.state.storeAdminAboutUs.edit.data
    ...
    methods: {
        ...
        clickSubmitEdit() {
            ...
            this.$store.dispatch('actionAboutUsEdit', { vue: this, params, id: this.$route.params.id });
        },
