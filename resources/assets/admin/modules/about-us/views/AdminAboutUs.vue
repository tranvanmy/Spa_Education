...
<script>
    ...
    export default {
        ...
        beforeCreate() {
            ...
            this.$store.dispatch('actionFetchAboutUs', { vue: this })
        },
        ...
        methods: {
            clickAddNewItem() {
                return this.$router.push({ path: '/about-us/add' })
            },

            clickEditItem(data) {
                return this.$router.push({ path: `/about-us/edit/${data.id}` })
            },
            ...
            async clickDeleteItem(id) {
                return id
                    ...
                    && this.$store.dispatch('actionAboutUsDelete', { vue: this, id })
            },

            changePage(page) {
                this.$store.dispatch('actionAboutUsSetPage', { page })
            },

            handleChangeValueFilter(value) {
                return this.$store.dispatch('actionAboutUsSetFilter', { value: value.trim() })
            },
        },
        ...
        computed: {
            currentPage: {
                get() {
                    return this.$store.state.storeAdminAboutUs.currentPage
                },
                set(value) {}
            },

            valueFilter() {
                return this.$store.state.storeAdminAboutUs.valueFilter
            },
            ...
            items() {
                return this.$store.state.storeAdminAboutUs.listFetch
            },
        },
    }
</script>
