...
<script>
    ...
    export default {
        ...
        beforeCreate() {
            ...
            this.$store.dispatch('actionFetchProducts', { vue: this })
        },
        ...
        methods: {
            ...
            clickEditItem(data) {
                return this.$router.push({ path: `/products/edit/${data.id}` })
            },
            ...
            async clickDeleteItem(id) {
                return id
                    ...
                    && this.$store.dispatch('actionProductDelete', { vue: this, id })
            },
        ...
        computed: {
            ...
            items() {
                return this.$store.state.storeAdminProduct.listFetch
            },
        },
    }
</script>
