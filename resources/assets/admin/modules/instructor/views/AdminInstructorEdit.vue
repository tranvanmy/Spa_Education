                ...
                <b-form validated>
                   ...
                   <b-tabs pills card>
                       ...
                       >
                           ...
                           <b-row>
                               <b-col sm="12">
                                   <b-form-fieldset :label="$t('textSpecialized')">
                                       <b-form-input
                                           type="text"
                                           v-model="formData[language.key].specialized"
                                           :placeholder="$t('textSpecialized')"
                                       />
                                   </b-form-fieldset>
                               </b-col>
                           </b-row>
...
export default {
    ...
    async beforeCreate() {
        ...
        await this.$store.dispatch('actionInstructorShow', { vue: this, id: this.$route.params.id })
    },
    ...
    computed: {
        formData() {
            let data = this.$store.state.storeAdminInstructor.edit.data
    ...
    methods: {
        ...
        getCurrentImages() {
            return [this.$store.state.storeAdminInstructor.edit.data.image_url]
        },
        ...
        clickSubmitEdit() {
            ...
            this.$store.dispatch('actionInstructorEdit', { vue: this, params, id: this.$route.params.id });
        },

        clickCancel() {
            return this.$router.push({ path: '/instructors' })
        },
    }
}
</script>
